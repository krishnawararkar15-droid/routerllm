...
import { LayoutDashboard, Key, BarChart3, FileText, Zap, Settings, Bell, Layers, Code2, CreditCard, Shield, LogOut, Copy, Check, BookOpen, Terminal, AlertCircle, Menu, X, Sliders } from 'lucide-react';
        ...
        {mobileMenuOpen && (
          <>
            ...
            >
              ...
              <SidebarContent userEmail={userEmail} stats={null} profilePopupOpen={profilePopupOpen} setProfilePopupOpen={setProfilePopupOpen} profileRef={profileRef} />
            </motion.aside>
          </>
        )}
      </AnimatePresence>
